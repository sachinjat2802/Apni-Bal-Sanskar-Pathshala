                    ...
                    <div className="left">
                        <ul>
                            <li>
                                ...
                                <Link href="/our-document.html#">31, Green Park Extension, Nangal Jaisa Bohra, Jaipur.</Link>
                            </li>
                            <li>
    ...
    <div className="navbar-area sticky-top">
        ...
        <div className="mobile-nav">
            <Link href="/" className="logo">
                <Image width={200} height={60} style={{ height: "auto" }} src="/images/logo.png" alt="Logo" />
            </Link>
        </div>
            ...
            <div className="container">
                <nav className="navbar navbar-expand-md navbar-light">
                    <Link className="navbar-brand" href="/">
                        <Image width={200} height={60} style={{ height: "auto" }} src="/images/logo.png" className="logo-one" alt="Logo" />
                        <Image width={200} height={60} style={{ height: "auto" }} src="/images/logo.png" className="logo-two" alt="Logo" />
                    </Link>
                    <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link href="/our-document.html#" className="nav-link dropdown-toggle">Donations <i
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li className="nav-item">
                                        <Link href="/our-document.html#" className="nav-link">Donation Details</Link>
                                    </li>
                                </ul>
                            </li>
                         ...
                         <div className="side-nav">
                            <Link className="donate-btn" href="/our-document.html#" data-bs-toggle="modal" data-bs-target="#donationModal">
                                Donate
            ...
            <div className="row">
                <div className="col-lg-4">
                    <div className="our-documents">
                        <Image width={420} height={594} style={{ width: "100%", height: "auto" }} src="/images/documents/1.jpeg" alt="" />
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="our-documents">
                        <Image width={420} height={594} style={{ width: "100%", height: "auto" }} src="/images/documents/2.jpeg" alt="" />
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="our-documents">
                    ...
                    <div className="footer-item">
                        <div className="footer-logo">
                            <Link className="logo" href="/">
                                <Image width={200} height={60} style={{ height: "auto" }} src="/images/logo.png" className="w-25" alt="Logo" />
                            </Link>
                        ...
                        <div className="footer-causes">
                            ...
                            <div className="cause-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <h3>
                                            <Link href="/our-document.html#">Education for Underprivileged Children</Link>
                                        </h3>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="cause-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <h3>
                                            <Link href="/our-document.html#">Support Environmental Protection</Link>
                                        </h3>
                                    </li>
                                </ul>
                            </div>
            ...
            <div className="modal-content custom-modal">
                ...
                <div className="modal-body p-4">
                    ...
                    <div className="d-flex gap-3 mb-3">
                        <Image width={48} height={48} src="https://img.icons8.com/color/48/visa.png" alt="Visa" />
                        <Image width={48} height={48} src="https://img.icons8.com/color/48/mastercard.png" alt="Mastercard" />
                        <Image width={48} height={48} src="https://img.icons8.com/color/48/paypal.png" alt="Paypal" />
                    </div>
