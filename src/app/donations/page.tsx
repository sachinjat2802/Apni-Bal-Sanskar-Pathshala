  ...
  return (
    <>
      <div>
                ...
                >
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                      ...
                      >
                        Donations <i className="icofont-simple-down" />
                      </Link>
                      <ul className="dropdown-menu">
                        <li className="nav-item">
                          <Link href="/donations" className="nav-link">
                            Donations
                          </Link>
                        </li>
                        <li className="nav-item">
                          <Link href="/donation-details" className="nav-link">
                            Donation Details
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li className="nav-item">
                      <Link href="/our-document" className="nav-link">
                        Documents
                      </Link>
                    </li>
                    {/* <li class="nav-item">
          ...
          <div className="container">
              ...
              <div className="col-sm-6 col-lg-4">
                <div className="donation-item">
                  <div className="img">
                    ...
                    <Link className="common-btn" href="/donation-details">
                      Donate Now
                    </Link>
                  </div>
                  <div className="inner">
                    <div className="top">
                      <Link className="tags" href="/donations.html#">
                        #Medical
                      </Link>
                      <h3>
                      ...
                      <p>
                        We exist for non-profits, social enterprises, activists.
                        Lorem politicians and individual citizens.
                      </p>
                    </div>
            ...
            <div className="pagination-area">
              <ul>
                ...
                <li>
                  <Link className="active" href="/donations.html#">
                    1
                  </Link>
                </li>
                <li>
        ...
        <section
          className="donation-area py-5 text-center feature-area"
          style={{}}
        >
          <div className="container">
            <div className="section-title">
              ...
              <p className="text-white">
                Your support helps us educate and empower children for a better
                future.
              </p>
            </div>
            <div className="donation-box">
              ...
              <p>
                <strong>UPI ID:</strong> uthan98286894@barodampay
              </p>
            </div>
          </div>
        </section>
        ...
        <footer className="footer-area pt-100">
          <div className="container">
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="footer-item">
                  <div className="footer-logo">
                    ...
                    <p>
                      We are committed to creating a positive impact by
                      providing education, promoting health and wellness,
                      protecting the environment, and supporting underprivileged
                      communities.
                    </p>
                    <ul>
                      <li>
            ...
            <div className="copyright-area">
              <p>Copyright @ Uthan seva sansthan.</p>
            </div>
          </div>
        </footer>
        {/* End Footer */}
