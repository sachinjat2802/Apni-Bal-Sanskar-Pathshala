              ...
              <nav className="navbar navbar-expand-md navbar-light">
                ...
                <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                      <a href="#" className="nav-link dropdown-toggle">Donations <i className="icofont-simple-down" /></a>
            ...
            <div className="row">
              <div className="col-sm-6 col-lg-4">
                <div className="donation-item">
                  <div className="img">
                    ...
                    <a className="common-btn" href="/donation-details">Donate Now</a>
                  </div>
                  <div className="inner">
                    <div className="top">
              ...
              <div className="col-sm-6 col-lg-4">
                <div className="donation-item">
                  ...
                  <div className="inner">
                    <div className="top">
                      <a className="tags" href="#">#Drought</a>
                      <h3>
        ...
        <section className="donation-area py-5 text-center feature-area" style={{}}>
          <div className="container">
            ...
            <div className="donation-box">
              <img src="/images/qr.jpeg" alt="UPI QR Code" style={{maxWidth: 300, width: '100%', borderRadius: 10}} />
