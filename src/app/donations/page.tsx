                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="/donation-details" className="nav-link">
                          Donation Details
                        </a>
                      </li>
                    </ul>
        ...
        <div className="container">
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="donation-item">
                <div className="img">
                  ...
                  <a className="common-btn" href="/donation-details">
                    Donate Now
                  </a>
                </div>
                <div className="inner">
                  <div className="top">
                    <a className="tags" href="/donations.html#">
                      #Medical
                    </a>
                    <h3>
          ...
          <div className="pagination-area">
            <ul>
              ...
              <li>
                <a className="active" href="/donations.html#">
                  1
                </a>
              </li>
              <li>
