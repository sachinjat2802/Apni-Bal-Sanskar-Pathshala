  ...
  return (
    <html lang="zxx">
      ...
      <body>
        ...
        />
        <Script
          src={`${basePath}/js/form-validator.min.js`}
          strategy="lazyOnload"
        />
        <Script
          src={`${basePath}/js/contact-form-script.js`}
          strategy="lazyOnload"
        />
        <Script
          src={`${basePath}/js/jquery.ajaxchimp.min.js`}
          strategy="lazyOnload"
        />
        <Script
          src={`${basePath}/js/jquery.meanmenu.js`}
          strategy="lazyOnload"
        />
        <Script
          src={`${basePath}/js/jquery-modal-video.min.js`}
          strategy="lazyOnload"
        />
        <Script src={`${basePath}/js/wow.min.js`} strategy="lazyOnload" />
        <Script src={`${basePath}/js/lightbox.min.js`} strategy="lazyOnload" />
        <Script
          src={`${basePath}/js/owl.carousel.min.js`}
          strategy="lazyOnload"
        />
        <Script src={`${basePath}/js/odometer.min.js`} strategy="lazyOnload" />
        <Script
          src={`${basePath}/js/jquery.appear.min.js`}
          strategy="lazyOnload"
        />
        <Script
          src={`${basePath}/js/jquery.nice-select.min.js`}
          strategy="lazyOnload"
        />
