                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <a href="/donation-details.html#" className="nav-link">
                          Donation Details
                        </a>
                      </li>
                    </ul>
            ...
            <div className="col-lg-8">
              <div className="details-item">
                <div className="details-img">
                  ...
                  <h2>
                    Join Our Yoga Initiative for a Healthier & Balanced Life
                  </h2>
                  <p>
                    Our yoga program is dedicated to promoting physical health,
                    mental peace, and emotional well-being. In today’s
                    fast-paced world, stress and unhealthy lifestyles are
                    becoming common problems. Through yoga, we aim to help
                    individuals reconnect with their body, mind, and inner self.
                  </p>

                  <p>
                    We organize regular yoga sessions, meditation camps, and
                    wellness workshops for people of all age groups. Our
                    experienced instructors guide participants through various
                    asanas, breathing techniques, and relaxation methods that
                    improve flexibility, strength, and overall health.
                  </p>

                  <p>
                    It is a well-known fact that practicing yoga daily not only
                    enhances physical fitness but also reduces stress, improves
                    concentration, and brings positivity into life. Our mission
                    is to spread awareness about the importance of yoga and make
                  ...
                  <p>
                    We believe that a healthy society begins with healthy
                    individuals. With your support, we aim to expand our yoga
                    initiatives to rural and urban areas, helping more people
                    lead a balanced and peaceful life.
                  </p>

                  <p>
                    Join us in this journey towards better health and inner
                    harmony. Together, let’s create a stress-free and healthier
                    future through the power of yoga.
                  </p>
                </div>
                  ...
                  <div className="post-inner">
                    <ul className="align-items-center">
                      ...
                      <li>
                        ...
                        <p>
                          By - <a href="/donation-details.html#">Admin</a>
                        </p>
                      </li>
                    </ul>
                  </div>
                  <div className="post-inner">
                    <ul className="align-items-center">
                      ...
                      <li>
                        <h4>
                          <a href="/donation-details.html#">
                            Charity meetup in Berlin next year
                          </a>
                        </h4>
                        <p>
                          By - <a href="/donation-details.html#">Admin</a>
