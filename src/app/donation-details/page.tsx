                ...
                <div className="col-lg-8">
                    <div className="details-item">
                        ...
                        <div className="details-img">
                            <Image src="/images/gallary-img/20.jpeg" alt="Details" width={400} height={300} />
                        ...
                        <div className="post widget-item">
                            ...
                            <div className="post-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <Image src="/images/gallary-img/2.jpeg" alt="Details" width={400} height={300} />
                                    </li>
                                    <li>
                                        <h4>
                            ...
                            <div className="post-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <Image src="/images/gallary-img/3.jpeg" alt="Details" width={400} height={300} />
                                    </li>
                                    <li>
                                        <h4>
                            ...
                            <div className="post-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <Image src="/images/gallary-img/4.jpeg" alt="Details" width={400} height={300} />
                                    </li>
                                    <li>
                                        <h4>
                            ...
                            <div className="post-inner">
                                <ul className="align-items-center">
                                    <li>
                                        <Image src="/images/gallary-img/5.jpeg" alt="Details" width={400} height={300} />
                                    </li>
                                    <li>
                                        <h4>
            ...
            <div className="modal-content custom-modal">
                ...
                <div className="modal-body p-4">
                    ...
                    <div className="d-flex gap-3 mb-3">
                        <Image src="https://img.icons8.com/color/48/visa.png"  alt="Payment Icon" width={48} height={48} unoptimized />
                        <Image src="https://img.icons8.com/color/48/mastercard.png"  alt="Payment Icon" width={48} height={48} unoptimized />
                        <Image src="https://img.icons8.com/color/48/paypal.png"  alt="Payment Icon" width={48} height={48} unoptimized />
                    </div>
