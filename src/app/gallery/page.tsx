      ...
      <section className="gallery-area two pt-100 pb-70">
        <div className="container-fluid">
          <div className="section-title">
            ...
            <p>
              We proudly showcase the moments that reflect our dedication and
              impact. Our gallery highlights the activities, events, and
              initiatives that define who we are.
            </p>
          </div>
          <div className="row">
            {/* 1 */}
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/10.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/10.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/11.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/11.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/13.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/13.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/15.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/15.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/16.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/16.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/17.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/17.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/18.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/18.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/19.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/19.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/20.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/20.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/22.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/22.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/23.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/23.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/24.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/24.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/25.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/25.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/26.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/26.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/27.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/27.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/28.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/28.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/29.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/29.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/30.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/30.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/31.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/31.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/32.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/32.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/33.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/33.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/34.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/34.jpeg"
                    className="img-fluid"
                    alt="Gallery 10"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/35.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/35.jpeg"
                    className="img-fluid"
                    alt="Gallery 35"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/36.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/36.jpeg"
                    className="img-fluid"
                    alt="Gallery 36"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/37.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/37.jpeg"
                    className="img-fluid"
                    alt="Gallery 37"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/38.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/38.jpeg"
                    className="img-fluid"
                    alt="Gallery 38"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/39.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/39.jpeg"
                    className="img-fluid"
                    alt="Gallery 39"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/40.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/40.jpeg"
                    className="img-fluid"
                    alt="Gallery 40"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/41.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/41.jpeg"
                    className="img-fluid"
                    alt="Gallery 41"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/42.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/42.jpeg"
                    className="img-fluid"
                    alt="Gallery 42"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/43.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/43.jpeg"
                    className="img-fluid"
                    alt="Gallery 43"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/44.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/44.jpeg"
                    className="img-fluid"
                    alt="Gallery 44"
                  />
                  <i className="icofont-eye"></i>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
              <div className="gallery-item">
                <a href="/images/gallary-img/45.jpeg" data-lightbox="roadtrip">
                  <img
                    src="/images/gallary-img/45.jpeg"
                    className="img-fluid"
                    alt="Gallery 45"
                  />
                  <i className="icofont-eye"></i>
