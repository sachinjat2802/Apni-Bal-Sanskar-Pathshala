          ...
          <div className="row justify-content-center">
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="contact-info">
                ...
                <span>Email:</span>
                <a href="mailto:apni.bal.sanskarpathshala1@gmail.com">
                  apni.bal.sanskarpathshala1@gmail.com
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="contact-area pb-70">
        <div className="container">
          <form id="contactForm">
            <h2>Let's talk...!</h2>
            <p>
              Uttan Seva Sansthan is dedicated to serving society by supporting
              underprivileged communities and promoting a better quality of
              life. Our organization works continuously to provide essential
              services such as education, healthcare, food, and social awareness
              programs.
            </p>
            <div className="row">
              <div className="col-lg-6">
                ...
                <div className="form-group">
                  <div className="form-check agree-label">
                    ...
                    <label className="form-check-label" htmlFor="gridCheck">
                      Accept{" "}
                      <a href="https://uthansevasansthan.com/terms-condition.html">
                        Terms & Conditions
                      </a>{" "}
                      And{" "}
                      <a href="https://uthansevasansthan.com/privacy-policy.html">
                        Privacy Policy.
                      </a>
                    </label>
