    ...
    <div>
      {!isLoggedIn ? (
        <div id="login-container" className="bg-white p-8 rounded shadow-md w-full max-w-md">
          ...
          {showError && (
            <div id="error-msg" className="text-red-500 mb-4">Invalid credentials. Access denied.</div>
          )}
          <input
            type="text"
            id="username"
            placeholder="Username"
            className="w-full p-3 border mb-4 rounded text-black"
            value={username}
          ...
          <input
            ...
            className="w-full p-3 border mb-6 rounded text-black"
            value={password}
        ...
        <div id="dashboard-container" className="bg-white p-8 rounded shadow-md w-full max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 border rounded text-gray-800">
